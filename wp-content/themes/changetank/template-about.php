    ...
    <div class="container">
        <div class="grid-2 about-bio-grid">
            ...
            <div class="about-bio__text">
                ...
                <p>
                    His work sits at the intersection of program management, business transformation, and operational delivery. He has taken on the full spectrum of what that means in praction: standing up new operations from the ground up, transforming the way existing organisations work, managing large-scale technology deployments at the frontier of what industry has attempted, and guiding senior leaders through the decisions that matter most. He gets into the detail himself. He does not manage the work from a distance and delegate the difficult parts to junior analysts.
                </p>
                <p>
...
<section class="section" aria-labelledby="highlights-heading">
    <div class="container">
        ...
        <div class="grid-3 milestone-cards">
            ...
            <div class="milestone-card">
                <div class="milestone-card__accent" aria-hidden="true"></div>
                <p class="eyebrow">Innovation · Technology Programs</p>
